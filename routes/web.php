...
Route::get('/bootCart', function () {
    return view('bootstrapCart.boot');
});

Route::get('/faq', [FAQController::class, 'index'])->name('faq');
Route::get('/example', function () {
    return view('cartExample.cart');
});
// About Us
...
// Route::get('/practice', [ProductsController::class, 'indecs']); 
...
Route::middleware(['role:user'])->group(function () {
        Route::get('/mastercard', [MasterCardController::class, 'show'])->name('mastercard.payment');
        Route::post('/mastercard/payment/{order_id}', [MasterCardController::class, 'store'])->name('mastercard.payment2');
});
...
Route::get('/main/charts', [adminDashboardController::class, 'charts'])->name('charts');
...
Route::get('/pie',  [ChatController::class, 'getChatData'])->name('chat_data'); 
});
